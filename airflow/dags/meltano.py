...
if not pathlib.Path("/opt/airflow/meltano/.venv").exists():
...
project_root = '/opt/airflow/meltano'

meltano_bin = ".venv/bin/meltano"
...
result = subprocess.run(
    [".venv/bin/meltano", "schedule", "list", "--format=json"],
    cwd="/opt/airflow/meltano/",
